...
<head>
    <meta charset="utf-8">
    <meta name="csrf-token" content="JrlN3sSGBC9XZA47JUa5rs4EHclCyfoioIstD4ld">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="shortcut icon" href="https://dimarz.net/assets/frontend/img/icon.png" type="image/x-icon">
    ...
    <meta name="description" content="We Designed 15 Leads Samples For Our B2B Lead Generation Clients">
    <meta name="keywords" content="Lead Sample, Upwork Client Preview, lead generation, b2b generation, b2c lead, ">
    <meta name="geo.region" content="South Asia">
    <meta name="geo.position" content="23.802300129890487, 90.35285528814089">
    <meta name="ICBM" content="23.802300129890487, 90.35285528814089">
    <meta name="geo.placename" content="DiMarz">
    ...
    <meta name="dcterms.Identifier" content="https://dimarz.net/upwork-exclusive-sample-leads">
    <meta name="dcterms.Relation" content="DiMarz">
    <meta name="dcterms.Publisher" content="DiMarz">
    <meta name="dcterms.Type" content="text/html">
    <meta name="dcterms.Coverage" content="https://dimarz.net/upwork-exclusive-sample-leads">
    <meta name="dcterms.Title" content="Lead Sample - Upwork - Client Preview">
    <meta name="dcterms.Subject"
        content="Lead Sample, Upwork Client Preview, lead generation, b2b generation, b2c lead, ">
    <meta name="dcterms.Contributor" content="DiMarz.com">
    <meta name="dcterms.Description" content="We Designed 15 Leads Samples For Our B2B Lead Generation Clients">


    <!-- Facebook OpenGraph -->
    <meta property="og:locale" content="en">
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://dimarz.net/upwork-exclusive-sample-leads">
    ...
    <meta property="og:image" content="https://dimarz.net/assets/frontend/img/upwork/thumbnail.png">
    <meta property="og:site_name" content="DiMarz">


    <!-- Twitter Card -->
    <meta name="twitter:card" content="Dimarz">
    ...
    <meta name="twitter:image" content="https://dimarz.net/assets/frontend/img/upwork/thumbnail.png">
    ...
    <!--    Stylesheets-->
    <!-- ===============================================-->
    <link rel="stylesheet" href="https://dimarz.net/assets/frontend/css/upworkpage.css">
    <link rel="stylesheet" href="https://dimarz.net/assets/frontend/css/upworkpage-filter.css">
    <link rel="stylesheet" href="https://dimarz.net/assets/frontend/css/upworkpage-responsive.css">
    ...
    <link rel="stylesheet" href="https://dimarz.net/assets/frontend/css/sweetalert2.min.css">
    ...
    <style>
        ...
        .header_leftside .accordion-body {
        ...
        .giphy_effect {
            ...
            background-image: url('https://media.giphy.com/media/fu1cAil49jxpUnz0Ee/giphy-downsized-large.gif');
            background-image: url('https://media.giphy.com/media/cjz3AsU3yqvblMvZDj/giphy.gif');
            background-image: url('https://media.giphy.com/media/3ohhwgsTmM2nVohH32/giphy-downsized-large.gif');
            background-image: url('https://media.giphy.com/media/xT39DalImVfi9Asj1S/giphy.gif');
            background-image: url('https://media.giphy.com/media/UYHaGW6Ad5QOIm9T2w/giphy-downsized-large.gif');
            background-image: url('https://media.giphy.com/media/8Xabj5L1Of4i6LyQ1Q/giphy-downsized-large.gif');
            animation-delay: 4ms;
            background-position: center;
            background-size: cover;
            animation: giphy_change 20s linear infinite;
            font-size: 2rem;
            font-weight: bolder;
        ...
        /***************************************************
         15 Leads Samples giphy animation start here
         ******************************************************/
        @keyframes giphy_change {
            0% {
                background-image: url('https://media.giphy.com/media/SJXnSaKgXzKD1yRboI/giphy.gif')
            }
            ...
            100% {
                background-image: url('https://media.giphy.com/media/UYHaGW6Ad5QOIm9T2w/giphy.gif')
            }
        }
        ...
        /***************************************************
            15 Leads Samples giphy animation start here
        ******************************************************/
        .giphy_effect2::first-letter {
            color: transparent !important;
            -webkit-background-clip: text;
            -webkit-text-stroke: .7px #fff;
            background-image: url('https://media.giphy.com/media/ZxGWYQp79fAYmF1v0z/giphy-downsized-large.gif');
            background-image: url('https://media.giphy.com/media/UYHaGW6Ad5QOIm9T2w/giphy-downsized-large.gif');
            animation-delay: 4ms;
            background-position: center;
            background-size: cover;
    ...
    ******************************************************/
        ...
        ::-webkit-scrollbar-thumb {
            background: #222;
            animation: scrollbars 1s linear infinite;
            border-radius: 10px;
    ...
    ******************************************************/
        .thanks {
            color: transparent !important;
            -webkit-background-clip: text;
            -webkit-text-stroke: 1px #38E594;
            background-image: url('https://media.giphy.com/media/ZxGWYQp79fAYmF1v0z/giphy-downsized-large.gif');
            background-image: url('https://media.giphy.com/media/cR8RmSw908ksUijMzW/giphy-downsized-large.gif');
            background-image: url('https://media.giphy.com/media/f9R5T8a5sU4UHWfEVh/giphy.gif');
            animation-delay: 4ms;
            background-position: center;
            background-size: cover;
        ...
        .box_shadow_area .step_title {
            padding: 5px 40px;
            background: #262626;
            font-size: 40px;
            width: fit-content;
            background-color: #38e594;
            color: #fff;
            border-radius: 30px;
            text-transform: uppercase;
        }

        .box_shadow_at .bottom_part span:last-child {
            padding: 5px 50px;
            background: #262626;
            color: #fff;
            border-radius: 30px;
        ...
        .second_steps_right::before,
        .second_steps_right::after {
            display: none;
        }
        ...
        .second_steps_right h3.steps_super_title {
            position: relative;
            background: #202124;
            width: fit-content;
            font-size: 24px;
        ...
        .second_steps_right h3.steps_super_title {
            ...
            border-top-right-radius: 30px;
            border-bottom-right-radius: 30px;
            /* giphy animation effect start here */
        ...
        .second_steps_right .steps_super_title-2 {
            position: relative;
            background: #202126;
            width: fit-content;
            font-size: 24px;
        ...
        /* verticel text slider style code here */
        .text-slider{
    ...
    .texts{
        position: relative;
        animation: veticel_text_slider 20s linear infinite;
        transition: 1s;
        -webkit-animation: veticel_text_slider 20s linear infinite;
        -moz-animation: veticel_text_slider 20s linear infinite;
        -o-animation: veticel_text_slider 20s linear infinite;
        -webkit-animation-fill-mode: both;
    }
    @keyframes veticel_text_slider{
        0% {
            top: 0px;
        }
        20% {
...
@media (min-width: 320px) and (max-width: 480px) {
    ...
    .slider_box h6{
        ...
        color: #1dbf73!important;
            font-weight: bolder;
            -webkit-text-stroke: #1dbf73!important;
            /* -webkit-text-stroke: .5px #fff;
            -webkit-text-stroke-width: 1px;
            -webkit-font-smoothing: antialiased;
            -moz-osx-font-smoothing: grayscale;
...
<body>
    ...
    <main class="main" id="top">
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" data-navbar-on-scroll="data-navbar-on-scroll">
            <div class="container">
                <a class="navbar-brand" href="https://dimarz.net/upwork-exclusive-sample-leads">
                    <span class="text-1000 fs-3 ms-2 fw-medium branding"></span>
                    <span class="fw-bold">DiMarz.com</span>
                ...
                <div class="row pb-5">
                    <div class="col-sm-12 col-md-7 col-lg-7 mt-5 text-center text-md-start top_header_left">
                        <div class="header_top_left">
                            ...
                            <h4 class="header_font_01 giphy_effect">15 Leads Samples</h4>
                            {{-- service slider here --}}
                            <div class="text-slider d-flex">
                                {{-- <h1 class="header_font_01">For Our <b style="color:#1dbf73;">B2B</b> Lead Generation
                                    Clients</h1> --}}
                                    <h2>we will provide you: </h2>
                                    <div class="slider_box">
                                       <div class="texts">
                                        <h6 id="slider_text">b2b lead generation</h6>
                                        <h6 id="slider_text">b2c lead generation</h6>
                                        <h6 id="slider_text">real-estate lead generation</h6>
                                        <h6 id="slider_text">healthcare lead generation</h6>
                                        <h6 id="slider_text">education lead generation</h6>
                                        <h6 id="slider_text">finance lead generation</h6>
                                        <h6 id="slider_text">technology lead generation</h6>
                                        <h6 id="slider_text">retail lead generation</h6>
                                        <h6 id="slider_text">marketing lead generation</h6>
                                       </div>
                                    </div>
                            </div>
                            {{-- <script>
                            ...
                            <span>
                                <span style="font-size: 10px;color:#1dbf73;margin-right:5px;">
            ...
            <div class="container">
                <div class="col-sm-12 col-md-12 d-flex justify-content-center">
                    <a href="#table_section_area_fp" class="icon-font">
                        <span style="border-color:#1dbf73;border-radius:10px;" class="fontawesome-angle-down"></span>
                        <span style="color:#1dbf73;font-size;20px;font-weight:800;">
        ...
        <section style="padding-top: 1rem;" class="table_section bg_white" id="table_section_area">
            <div class="container">
                <div class="row py-4" id="table_section_area_fp">
                    ...
                    {{-- country data dropDown menu here --}}
                    <div class="col-sm-12 col-md-3 pe-2">
                        {{-- <div class="ui fluid search selection dropdown" id="country_Name">
                            ...
                            <div class="menu">
                                ...
                                <div class="item" data-value="USA"><i class="us flag"></i>USA</div>
                                <div class="item" data-value="USA"><i class="us flag"></i>USA</div>
                                <div class="item" data-value="USA"><i class="us flag"></i>USA</div>
                                <div class="item" data-value="USA"><i class="us flag"></i>USA</div>
                                <div class="item" data-value="USA"><i class="us flag"></i>USA</div>
                        ...
                        <select id="country"class="ui fluid search dropdown" style="border:none;padding:10px 15px;border-radius:5px;outline:none;border:1px solid #bbb;">
                            @foreach ($cuntry as $list)
                                <option class="item" selected value="{{ $list->id }}">{{ $list->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-sm-12 col-md-3 px-2">
                        <select class="ui fluid search dropdown" id="state" style="border:none;padding:10px 15px;border-radius:5px;outline:none;border:1px solid #bbb;">
                        </select>
                    </div>
                    <div class="col-sm-12 col-md-3 px-2" id="niche_Name_area">
                        <select class="ui fluid search dropdown city" id="city" style="border:none;padding:10px 15px;border-radius:5px;outline:none;border:1px solid #bbb;">
                        </select>
                    </div>
                    {{-- search data using input box --}}
                    <div class="col-sm-12 col-md-3 ps-2 pe-0 suggestion_input_area">
                        <input type="search" list="autosearch" style="border:none;padding:10px 15px;border-radius:5px;outline:none;border:1px solid #bbb;">
                        <datalist id="autosearch" class="dropdown">
                            <option value="Home"></option>
                            <option value="About"></option>
                            <option value="Serviec"></option>
                        </datalist>
            ...
            <div class="container" id="LetMakeACover_part">
                <div class="row">
                    <div class="col-sm-12 col-md-12 pb-3">
                        <h3 class="pt-5 font_20_onmobile giphy_effect2"
                            style="font-size: 40px;color: #ffff00;font-weight: 600;">Let
                            us know your
                            requirments</h3>

                        <h3 class="pb-5 font_15_onmobile" style="font-size: 40px;color: #1dbf73;font-weight: 600;">We
                            Design 2 Easy
                            Steps For You.</h3>
                    ...
                    <div class="col-sm-12 col-md-6 write_cover_text text-white gen_left_side second_steps_right">
                        ...
                        <div style="position: relative;z-index:1">
                            ...
                            <div class="d-flex py-3">
                                ...
                                <input type="text" id="gen_custom_location"
                                    class="form-control border_bottom py-1 px-2" placeholder="Example: USA"
                                    style="width: -webkit-fill-available;" required>
                            </div>
                            <div class="d-flex py-3">
                                <span style="min-width:100px;">Industry : </span>
                                <input type="text" id="gen_custom_industry"
                                    class="form-control border_bottom py-1 px-2"
                            ...
                            <div class="row m-0">
                                <label class="btn btn_cselection">
                                    First Name <input type="checkbox" name="p_fname" id="p_fname"
                                        value="First Name">
                                </label>
                                <label class="btn btn_cselection">
                                    Last Name <input type="checkbox" name="p_lname" id="p_lname"
                                        value="Last Name">
                                </label>
                                <label class="btn btn_cselection">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mt-3">
                                        ...
                                        <br>
                                        <input type="text" class=" username_input username" name="username"
                                            id="username_input" aria-describedby="helpId"
                                            placeholder="Please Enter Your Name!" required>
                                    </div>
                                </div>
                            </div>
                            {{-- username --}}
                            <p class="pt-5 pb-3"><span style="font-size: 20px;color:#fff"><i
                            ...
                            <textarea class="form-control px-2 py-2" name="" id="additional_text" rows="3"
                                style="background: #ddd;" placeholder="You can write here, if you have any additional query..."></textarea>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-1"></div>
                    <div class="col-sm-12 col-md-5 font_wieght_300 px-4 second_steps_right" style="padding:40px;">
                        <h3 class="steps_super_title-2">Step - 2</h3>
                        <div class="d-flex"
                            style="flex-direction: column;justify-content: space-between;height: 100%;">
                            <div class="row right_step">
                                <div class="col-12">
                                    ...
                                    <div class="user-thansk">
                                        ...
                                        <p id="prev_username" style="text-transform: capitalize;">
                                            Your Name,
                                        </p>
                                    </div>
                                    <p class="pt-1 mt-0" style="color: #48f9a6;font-size: 13px;">* Starting/Delivery
                                        Time and Rate of the
                                        project will be fixed after dissuasion.</p>
                                </div>

                                <div class="col-12 pb-3" style="background: ;z-index: 5;position: relative;">
                                    <button id="copy_text_r_upwork" class="py-2 btn btn-upwork float-end mr-3"
                                        title="copy info">Copy</button>
                                    {{-- copy past button and pdf download button here --}}

                                    <button id="download_pdf" class="py-2 btn btn-upwork float-end"
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 col-md-6 box_shadow_area">
                        <div class="box_shadow_at" style="border:2px solid #f3eeee;">
                            <div class="top_part">
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center py-5">
                    <div class="col-sm-12 col-md-5 text-white py-5">
                        ...
                        <p class="text-center">We are very happy for your valuable time to visiting this page. Hope you
                            like the samples Leads here. Let us know your needs at Upwork, we are always at your
                            service.</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <p class="text-white text-center">&copy; Copyright 2023. Development By <a
                                href="https://dimarz.net" style="color:#1dbf73;">Dimarz.com</a></p>
                    </div>
                </div>
            </div>
        </section>
    ...
    download_pdf.addEventListener("click", function() {
        var doc = new jsPDF();
        doc.setFontSize(12);
        doc.text(5, 86, `${form_info}`);
        let imgurl =
            `data:image/jpeg;base64,`
        doc.addImage(imgurl, 'png', 0, 1, 210, 80);
        doc.save('dimarz.pdf');
    ...
    <script>
       function CUNTRY_STATE_CITY(){
        $(document).ready(function() {
            ...
            // cuntry and state post request here
            $('#country').change(function() {
                var cid = $(this).val();
                console.log(cid)
                $.ajax({
                    type: 'post',
                    url: '{{ url('/getstate') }}/' + cid,
                    dataType: 'json',
                    success: function(data) {
                        if(data['states']['state'].length>0){
                            console.log(data['states'])
                        }
                     $("#state").find('option:not(:first)').remove();
                        $.each(data['states']['state'],function(key,value){
       ...
       // cuntry and state post request here
      //get All City post request here
    $('#state').change(function(){
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if(data['city']['city'].length>0){
                    console.log(data['states'])
                }
                $.each(data['city']['city'],function(key,value){
    ...
    <script src="https://dimarz.net/assets/frontend/js/upwork/popper.min.js"></script>
    <script src="https://dimarz.net/assets/frontend/js/bootstrap.bundle.min.js"></script>
    <script src="https://dimarz.net/assets/frontend/js/upwork/is.min.js"></script>
    <script src="https://dimarz.net/assets/frontend/js/upwork/custom.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/semantic-ui/2.5.0/semantic.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.9.0/js/all.min.js"></script>
    <script src="https://dimarz.net/assets/frontend/js/upwork/theme.js"></script>
    <script src="https://dimarz.net/assets/frontend/js/sweetalert2.all.js"></script>
    ...
    <script>
        function generate_message() {
            ...
            // client username here
            if (username != '') {
                var gen_custom_quantity_message = gen_custom_quantity;
                $('#prev_username').html(username);
            } else {
                var gen_custom_quantity_message = gen_custom_quantity;
                $('#prev_username').html('N/A');
            }
            // client username here
            ...
            const texts = `\n\nThanks For Your Time And Considerations,\n\nBest Regards,\n\n`;
            $('#message_show_box').text(gen_custom_quantity_message + message2 + data_type + cl_additional_text + texts +
                username);
            console.log(gen_custom_quantity_message + message2 + data_type + cl_additional_text +
                `\n\nThanks For Your Time And Considerations,\n\nBest Regards,\n\n` + username);
            // let allData=gen_custom_quantity_message + message2 + data_type + cl_additional_text + texts + username;
            form_info = gen_custom_quantity_message + message2 + data_type + cl_additional_text +
                `\n\nThanks For Your Time And Considerations,\n\nBest Regards,\n\n` + username;
        }
        // show Messages Box
    ...
    <script>
        function searchbyinputs() {
            ...
            $.ajax({
                type: 'POST',
                url: `https://dimarz.net/search/leadBycountry`,
                data: {
                    'country': country,
                    'industry': industry,
                    'niche': niche,
        ...
        $('#industry_Name').change(function() {
            ...
            $.ajax({
                type: 'POST',
                url: `https://dimarz.net/search/nicheupdate`,
                data: {
                    'industry': industry,
                },
                success: function(data) {
        ...
        $('.suggestion_input').on('keyup', function() {
            ...
            $.ajax({
                url: "https://dimarz.net/search/selectsearch",
                method: "POST",
                data: {
                    // 'newinput': $(this).text(),
            ...
            $.ajax({
                url: "https://dimarz.net/search/randomsearch",
                method: "POST",
                data: {
